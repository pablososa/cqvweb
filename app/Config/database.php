...
//        'password' => '',
    ...
    public function __construct() {
        if (!IS_DEVELOPMENT_SERVER) {
            $this->default['host'] = $_ENV['OPENSHIFT_MYSQL_DB_HOST'];
            $this->default['port'] = $_ENV['OPENSHIFT_MYSQL_DB_PORT'];
            $this->default['login'] = $_ENV['OPENSHIFT_MYSQL_DB_USERNAME'];
            $this->default['password'] = $_ENV['OPENSHIFT_MYSQL_DB_PASSWORD'];
        } else {
            $this->default['host'] = '127.0.0.1';
            $this->default['port'] = 3306;
            $this->default['login'] = 'root';
            $this->default['password'] = '1234';
            $this->default['database'] = 'cqvunificado';
        }
    }
