...
class AcLucsComponent extends Component {
    ...
    function initialize(Controller $controller) {
        ...
        AcLucs::$user_allowed_actions['usuario']['usuarios'][] = 'balance';
        ...
        AcLucs::$user_allowed_actions['usuario']['usuarios'][] = 'cliente';
        ...
        AcLucs::$user_allowed_actions['usuario']['viajes'][] = '_view';
        ...
        AcLucs::$user_allowed_actions['empresa']['empresas'][] = 'config';
        ...
        AcLucs::$user_allowed_actions['empresa']['vehiculos'][] = 'liqrango';
        AcLucs::$user_allowed_actions['empresa']['vehiculos'][] = 'inicio';
        AcLucs::$user_allowed_actions['empresa']['vehiculos'][] = 'dash';
        AcLucs::$user_allowed_actions['empresa']['vehiculos'][] = 'balance';
        AcLucs::$user_allowed_actions['empresa']['vehiculos'][] = 'ingmov';


        AcLucs::$user_allowed_actions['empresa']['usuarios'][] = 'customerHistory';
        AcLucs::$user_allowed_actions['empresa']['usuarios'][] = 'cliente';
        ...
        AcLucs::$user_allowed_actions['empresa']['ivr_clientes'][] = 'liquidacion';
        AcLucs::$user_allowed_actions['empresa']['ivr_clientes'][] = 'liquidar';
        AcLucs::$user_allowed_actions['empresa']['ivr_clientes'][] = 'liqrango';
        ...
        AcLucs::$user_allowed_actions['empresa']['notificacions'][] = 'index';
        AcLucs::$user_allowed_actions['empresa']['notificacions'][] = 'add';
        AcLucs::$user_allowed_actions['empresa']['notificacions'][] = 'edit';
        AcLucs::$user_allowed_actions['empresa']['notificacions'][] = 'delete';
        ...
        AcLucs::$user_allowed_actions['empresaadmin']['conductors'][] = 'eliminar';
        //======================================================================
        //admin
        //======================================================================
        ...
        AcLucs::$user_allowed_actions['admin']['empresas'][] = 'config';
        ...
        AcLucs::$user_allowed_actions['admin']['usuarios'][] = 'relacionar';
        ...
        AcLucs::$user_allowed_actions['admin']['vehiculos'][] = 'liqrango';
        AcLucs::$user_allowed_actions['admin']['vehiculos'][] = 'inicio';
        AcLucs::$user_allowed_actions['admin']['vehiculos'][] = 'dash';
        AcLucs::$user_allowed_actions['admin']['vehiculos'][] = 'balance';
        AcLucs::$user_allowed_actions['admin']['vehiculos'][] = 'ingmov';
