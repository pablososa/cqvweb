                    ...
                    <?php else: ?>
                        <table class="table table-hover table-striped">
                            ...
                            foreach ($conductores as $conductor) {
                                $actions = $this->html->link('Edit', array('controller' => 'conductors', 'action' => 'edit', $conductor['Conductor']['id']));
                                $actions .= $spacer . $this->html->link('View', array('controller' => 'conductors', 'action' => 'history', $conductor['Conductor']['id']));
                                if (isset($admin)) {
