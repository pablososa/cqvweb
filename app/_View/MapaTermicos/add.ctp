                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                             <?php echo __('Formulario de registro de eventos'); ?>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>  <?php echo __('Formulario de registro de eventos'); ?>
                            </li>
        ...
        <section id = "content" class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="form-group">
                 ...
                 <div class="col-md-6"> 
                 <div class="form-group">
                        <label> <?php echo __('Total Attendance'); ?> </label>
                        <?php
