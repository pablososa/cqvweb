        ...
        <?php else: ?>
            <table class="table table-hover table-striped table-admin-pendientes">
                ...
                $ths = array(
                    ...
                    $this->Paginator->sort('Viaje.creador', __('Creador')),
                ...
                <?php foreach ($viajes as $viaje) : ?>
                    ...
                    if ($viaje['Viaje']['atrasado'] and $viaje['Viaje']['estado']=="Pendiente" ) {
                        $tr_class[] = 'atrasado';
                    }
                    if ($viaje['Viaje']['atrasado'] and $viaje['Viaje']['estado']=="Aceptado" ) {
                        $tr_class[] = 'atrasado2';
                    }
                    ...
                    <tr class="<?php echo $tr_class; ?>">
                        ...
                        <td><?php echo $viaje['Viaje']['creador']; ?></td>
                        <td class="actions">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <?php 
                                            $obs = $viaje['Viaje']['observaciones'];
                                            $obs2 = explode('-', $obs);
                                            $obs3 = explode('Tel', $obs2[0]);
                                            if (count($obs3)==2){
                                                echo $obs2[1].'<h5>Telefono</h5>'.$obs3[1];
                                            }else{
                                                echo $obs;
                                            }
