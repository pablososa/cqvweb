                ...
                <section id = "content" class="col-md-9">
                    <div class="row">
                        <div class="col-md-6"> 
                            ...
                            <div class = "form-group">
                                    <label> <?php echo __('Documentacion'); ?> </label>
                                    <br>
                                    <div class="thumbnail-edit-cont">
                                        <div class="thumbnail">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <div class = "form-group">
                                    <label> <?php echo __('Formularios'); ?> </label>
                                    <br>
                                    <div class="thumbnail-edit-cont">
                                        <div class="thumbnail">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $this->Form->input('licencia', array('label' => false, 'type' => 'text', 'class' => 'form-control')); ?>
                            </div>  
