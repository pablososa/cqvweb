                ...
                <div class = 'row'>
                    ...
                    <div class = "input-group input-group-lg">
                        ...
                        <span class="input-group-btn">
                            ...
                            <?php echo $this->Html->link(__('Crear Viaje Fijo'), array('controller' => 'mapaTermicos', 'action' => 'add'), array('class' => 'btn btn-sm', 'div' => false)); ?>
                    ...
                    <div class="row">
                        <table class = "table table-condensed">
                            ...
                            $tableHeaders = $this->Html->tableHeaders(
                                    array(
                                        $this->Paginator->sort('business', __('Nombre')),
                                $this->Paginator->sort('descripcion', __('Observaciones')),
                                $this->Paginator->sort('direccion', __('Direccion')),
                                $this->Paginator->sort('cant_personas', __('Costo')),
                                 __('Acciones'),
                                '',
                                ''
                                    ), array(
