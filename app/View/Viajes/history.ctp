                    ...
                    <table class="table table-hover table-striped">
                        ...
                        $tableHeaders = $this->Html->tableHeaders(
                            array(
                                ...
                                $this->Paginator->sort('espera_tiempo', __('Espera')),
                                $this->Paginator->sort('espera_monto', __('Importe')),
         						'Total',
                        ...
                        <?php foreach ($viajes as $viaje) : ?>
                            <tr>
                                ...
                                <td>$<?php echo round($viaje['Viaje']['tarifa'],0); ?></td>
                                <td><?php echo $viaje['Viaje']['espera_tiempo']; ?></td>
                                <td>$<?php echo round($viaje['Viaje']['espera_monto'],0); ?></td>
								<td>$<?php echo round($viaje['Viaje']['tarifa']+$viaje['Viaje']['espera_monto'],0); ?></td>
