...
$(document).ready(function() {  
	...
	'<li><a href="/app/webroot/css/orange.css" style="background:#F86D18">Orange</a></li>' +
	'<li><a href="/app/webroot/css/yellow.css" style="background:#FFCC00">Yellow</a></li>' +
	'<li><a href="/app/webroot/css/sea-green.css" style="background:#3CB6B6">Sea green</a></li>' +
	'<li><a href="/app/webroot/css/green.css" style="background:#A4C618">Green</a></li>' +
	'<li><a href="/app/webroot/css/blue.css" style="background:#136597">Dark blue</a></li>' +
	'<li><a href="/app/webroot/css/light.css" style="background:#44BCDD">Light blue</a></li>' +
	'<li><a href="/app/webroot/css/pink.css" style="background:#F897F5">Pink</a></li>' +
	'<li><a href="/app/webroot/css/coffee.css" style="background:#A38757">Coffee</a></li>' +
	'<li><a href="/app/webroot/css/red.css" style="background:#E44832">Red</a></li>' +
	'<li><a href="/app/webroot/css/dark.css" style="background:#555">Purple</a></li>' +
	'</ul>' + 
   ...
   $('body').append($colorsHTML);  
    ...
    s.src = '/app/webroot/js/jquery.cookie.js';
    $('body').append(s);  
...
jQuery(function($){
	...
	if($('#superSizedSlider').length){
		...
		$.supersized({
                    ...
                    {image : '/app/webroot/img/supersized-1.jpg', title : '<h1>We are creative kitties<br /><a href="#works" class="btn btn-primary">learn more</a></h1>', thumb : '', url : ''},

                    {image : '/app/webroot/img/supersized-2.jpg', title : '<h1>We build beautiful websites<br /><a href="#works" class="btn btn-primary">check our portfolio</a></h1>', thumb : '', url : ''},

                    {image : '/app/webroot/img/supersized-3.jpg', title : '<h1>That\'s how we like it<br /><a href="#works" class="btn btn-primary">call us</a></h1>', thumb : '', url : ''}
                    ],
